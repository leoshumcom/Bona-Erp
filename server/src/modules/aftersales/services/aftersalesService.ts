...
export async function createAfterSales(_userId: string, params: CreateAfterSalesParams) {
  ...
  return prisma.afterSales.create({
    data: {
      ...
      refundAmount: params.refundAmount != null ? new Prisma.Decimal(params.refundAmount) : null,
      logisticsFee: params.logisticsFee != null ? new Prisma.Decimal(params.logisticsFee) : null,
      compensation: params.compensation != null ? new Prisma.Decimal(params.compensation) : null,
      lossAmount: params.lossAmount != null ? new Prisma.Decimal(params.lossAmount) : null,
